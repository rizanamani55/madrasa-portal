...
export const trackerRecordSchema = z.object({
  ...
  subh: z.number().min(0, "Marks cannot be negative").default(0),
  duhr: z.number().min(0, "Marks cannot be negative").default(0),
  asr: z.number().min(0, "Marks cannot be negative").default(0),
  magrib: z.number().min(0, "Marks cannot be negative").default(0),
  isha: z.number().min(0, "Marks cannot be negative").default(0),
